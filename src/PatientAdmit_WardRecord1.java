 ...
 private void Get_Data(){
          try{
              String sql="Select AdmitID as 'Admit ID',PatientRegistration.PatientID as 'Patient ID',"
                      ...
                      + "PatientRegistration.BG as 'Blood Group',Disease,AdmitDate as 'Admit Date',ward_table.Wardname as "
                      + "'Ward Name',doctor_table.DoctorID as 'Doctor ID',DoctorName as 'Doctor Name',"
    ...
    try{
            ...
            String table_click= jTable1.getModel().getValueAt(row, 0).toString();
             String sql="Select * from ward_table,doctor_table,PatientRegistration,AdmitPatient_Ward"
                     + " where ward_table.Wardname=AdmitPatient_Ward.Wardname and doctor_table.DoctorID="
                     + "AdmitPatient_Ward.DoctorID and PatientRegistration.PatientID=AdmitPatient_Ward.PatientID "
                     + "and AdmitID=" + table_click + "";   
            pst=con.prepareStatement(sql);
            rs=  pst.executeQuery();
            if(rs.next()){
                this.hide();
