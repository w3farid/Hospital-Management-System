...
PreparedStatement pst=null;
 ...
 private void Get_Data(){
         try{
         String sql="Select ID as 'Discharge ID', AdmitPatient_Room.AdmitID as 'Admit ID',patientregistration."
                 + "PatientID as 'Patient ID',patientregistration.PatientName as 'Patient Name',PatientRegistration."
                 + "Gen as 'Gender',PatientRegistration.BG as 'Blood Group',Disease,AdmitDate as 'Admit Date',"
                 + "Room_table.RoomNo as 'Room No',RoomCharges as 'Room Cahrges',Doctor_table.DoctorID as 'Doctor ID',DoctorName "
                 + "as 'Doctor Name',DischargeDate as 'Discharge Date',DP_Remarks as 'Remarks' from Room_table,Doctor_table,"
                 + "patientregistration,AdmitPatient_Room,DischargePatient_Room where Room_table.RoomNo="
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
      try{
            ...
            String table_click= jTable1.getModel().getValueAt(row, 0).toString();
             String sql="Select * from room_table,doctor_table,PatientRegistration,AdmitPatient_Room,DischargePatient_Room where"
                     + " room_table.RoomNo=AdmitPatient_Room.RoomNo and doctor_table.DoctorID=AdmitPatient_Room.DoctorID and "
                     + "PatientRegistration.PatientID=AdmitPatient_Room.PatientID and AdmitPatient_Room.AdmitID="
