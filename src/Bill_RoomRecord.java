 ...
 private void Get_Data(){
         try{
                 String sql="Select BillNo as 'Bill No.',DisChargePatient_Room.ID as 'Discharge ID',"
                         + " AdmitPatient_Room.AdmitID as 'Admit ID',patientregistration.PatientID as"
                         + " 'Patient ID',patientregistration.PatientName as 'Patient Name',patientregistration.Gen"
                         + " as 'Gender',patientregistration.BG as 'Blood Group',Disease,AdmitDate as 'Admit Date',"
                         + "Room_table.RoomNo as 'Room No',Doctor_table.DoctorID as 'Doctor ID',DoctorName as 'Doctor Name',"
                         + "DischargeDate as 'Discharge Date',Bill_Room.RoomCharges as 'Room Charges',"
                         + "Bill_Room.ServiceCharges as 'Service Charges',Bill_Room.BillingDate as 'Billing Date',"
                         + "PaymentMode as 'Payement Mode',PaymentModeDetails as 'Payment Mode Details',"
                         + "TotalCharges as 'Total Charges',ChargesPaid as 'Charges Paid',DueCharges as 'Due Charges',"
                         + "NoOfDays as 'No. Of Days',TotalRoomCharges as 'Total Room Charges' from Room_table,Doctor_table,"
                         + "patientregistration,AdmitPatient_Room,DischargePatient_Room,Bill_Room where Room_table.RoomNo="
                         ...
                         + " DischargePatient_Room.admitID and Bill_Room.DischargeID=DischargePatient_Room.ID  order "
                         + "by Billingdate"; 
