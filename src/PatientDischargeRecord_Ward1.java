 ...
 private void Get_Data(){
         try{
             String sql="Select ID as 'Discharge ID', AdmitPatient_Ward.AdmitID as 'Admit ID',"
                     ...
                     + "Disease,AdmitDate as 'Admit Date',Ward_table.Wardname as 'Ward Name',Charges as 'Bed Charges',"
                     ...
                     + "AdmitPatient_Ward,DischargePatient_Ward where Ward_table.Wardname=AdmitPatient_Ward.Wardname and "
                     + "Doctor_table.DoctorID=AdmitPatient_Ward.DoctorID and patientregistration.PatientID="
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
      try{
            ...
            String table_click= jTable1.getModel().getValueAt(row, 0).toString();
             String sql="Select * from Ward_table,Doctor_table,patientregistration,AdmitPatient_Ward,DischargePatient_Ward "
