...
PreparedStatement pst=null;
 ...
 private void Get_Data(){
       String sql="Select AdmitID as 'Admit ID',patientregistration.PatientID as 'Patient ID',"
               + "patientregistration.PatientName as 'Patient Name',patientregistration.Gen as "
               + "'Gender',patientregistration.BG as 'Blood Group',Disease,AdmitDate as 'Admit Date',"
    ...
    try{
            ...
            String sql="Select * from Room_table,Doctor_table,patientregistration,AdmitPatient_Room where"
                    + " Room_table.RoomNo=AdmitPatient_Room.RoomNo and Doctor_table.DoctorID="
                    + "AdmitPatient_Room.DoctorID and PatientRegistration.PatientID=AdmitPatient_Room.PatientID and "
                    + "AdmitID=" + table_click + "";   
            pst=con.prepareStatement(sql);
            rs=  pst.executeQuery();
            if(rs.next()){
