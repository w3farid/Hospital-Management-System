...
PreparedStatement pst=null;
 ...
 private void Get_Data(){
         try{
         String sql="Select ID as 'Discharge ID', AdmitPatient_Room.AdmitID as 'Admit ID',patientregistration.PatientID "
                 + "as 'Patient ID',patientregistration.PatientName as 'Patient Name',patientregistration.Gen as "
                 + "'Gender',patientregistration.BG as 'Blood Group',Disease,AdmitDate as 'Admit Date',room_table.RoomNo as"
                 + " 'Room No',doctor_table.DoctorID as 'Doctor ID',DoctorName as 'Doctor Name',DischargeDate as"
                 + " 'Discharge Date',DP_Remarks as 'Remarks' from room_table,doctor_table,patientregistration,AdmitPatient_Room,"
                 + "DischargePatient_Room where room_table.RoomNo=AdmitPatient_Room.RoomNo and"
                 + " doctor_table.DoctorID=AdmitPatient_Room.DoctorID and patientregistration.PatientID = "
                 + "AdmitPatient_Room.PatientID  and AdmitPatient_Room.admitID= DischargePatient_Room.admitID order by"
                 + " Dischargedate";
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
      try{
            ...
            String table_click= jTable1.getModel().getValueAt(row, 0).toString();
             String sql="Select * from Room_table,Doctor_table,patientregistration,AdmitPatient_Room,DischargePatient_Room where Room_table.RoomNo="
                     + "AdmitPatient_Room.RoomNo and Doctor_table.DoctorID=AdmitPatient_Room.DoctorID and "
                     + "PatientRegistration.PatientID=AdmitPatient_Room.PatientID and AdmitPatient_Room.AdmitID="
                     + "DischargePatient_Room.admitID and ID=" + table_click + "";   
            pst=con.prepareStatement(sql);
            rs=  pst.executeQuery();
            if(rs.next()){
                this.hide();
